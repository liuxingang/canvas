...
var screeSize = function(canvas,context,w,h){
    canvas.width = document.body.clientWidth;
    canvas.height = document.body.clientWidth * h / w;
    context.scale(document.body.clientWidth / w,document.body.clientWidth/ w);
}
